...
-->
                        ...
                        <p>
                                ...
                                <input name="paymentByChequeButton" type="button" class="transformButtonStyle" ONCLICK='document.invoice.payOpt.value = "RESEND";
                                                if (checkPay(this.form))
                                                    document.invoice.submit();
                        ...
                        if ($totaldue == 0 && $paytype != "") {
                            ...
                            <p>
                                <input name='Back2' type='button' class="transformButtonStyle" onClick="this.form.action = 'index.php';
                                                this.form.submit();" value='Go Back and Make Changes' />
                                <input type="button" class="transformButtonStyle" ONCLICK='document.invoice.payOpt.value = "RESEND";
                                                if (checkPay(this.form))
                                                    document.invoice.submit();
