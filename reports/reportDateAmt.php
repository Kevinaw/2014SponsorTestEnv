...
// -------------------------------------------------
                    ...
                    <form method='post' action='' name='report' ENCTYPE='multipart/form-data' >
                        ...
                        $totalreg = "SELECT * FROM $tablesponsor WHERE paytype!=''  ORDER BY '" . $orderby . "'";
                        ...
                        $totalpend = "SELECT * FROM $tablesponsor WHERE paytype=''  ORDER BY '" . $orderby . "'";
                        ...
                        $totalcancelled = "SELECT * FROM $tablesponsor WHERE reg_status='CANCELLED' ORDER BY '" . $orderby . "'";
                        ...
                        $totaljunk = "SELECT * FROM $tablesponsor ORDER BY '" . $orderby . "'";
...
//////////////////////// pull records to view and sort through ///////////////////////////////////
                        ...
                        $selectTotal = "SELECT * FROM $tablesponsor WHERE vid!='' " . $tutonly . " " . $selectdate2 . " ";
...
//						echo "<h1>".$resultNum."</h1>";
                        ...
                        $query3 = "SELECT * FROM $tablesponsor WHERE vid!='' " . $tutonly . " " . $selectdate2 . " ORDER BY " . $orderby . " " . $orderascdesc . " LIMIT $nextrecords,$recordsperpage";
                        ...
                        <p><strong>Show:</strong> 
                            ...
                            All Registrations&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            <input <?php
                            if (!(strcmp("$showresults", "tutorialonly"))) {
                                echo "checked=\"checked\"";
                            }
                            ?> name="showresults" type="radio" id="showresults2" value="tutorialonly"  onclick="document.report.submit();">
                            Tutorial 

                            Only Registrations</p>
                        <p><strong>Sort Results by:</strong> 
                            <input <?php
                            if (!(strcmp("$orderby", "vid"))) {
                                echo "checked=\"checked\"";
                            }
                        ...
                        <table width="100%" border="0" cellpadding="5" cellspacing="3">
                            ...
                            <?php for ($i = 0; $i < $goodrecordsnum; $i++) {
                                ...
                                ?>">
                                    <td valign="top"><p><strong>Invoice #: <?php echo $goodrecords[$i]['vid']; ?></strong></p></td>
                                    ...
                                    <td valign="top"><p><strong>Payment Type: </strong><?php echo $goodrecords[$i]['paytype']; ?> <br>
                                            Password Set: <?php
                                            if ($goodrecords[$i]['user_password'] != "") {
                                                echo "Yes";
                                            } else {
                                                echo "No";
                                            }
                                            ?> </p></td>
                                    <td ><p><a href="showInvoice.php?vid=<?php echo $goodrecords[$i]['vid']; ?>" target="_blank">View Invoice</a></p></td>
                                </tr>
                                <tr>
                                    <td nowrap><p>Registration Summary:</p></td>
                                    <td colspan="5"><p>
                                            <?php
                                            $findreg = "SELECT * FROM $tabledetailname WHERE vid='" . $goodrecords[$i]['vid'] . "' ORDER BY id asc";
                                            $regresults = mysql_query($findreg) or die(mysql_error());
                                            $regnum = mysql_num_rows($regresults);
                                            if ($regnum <= 0) {
                                                echo "<b>This record needs attention, it contains no registration data.</b>";
                                            } else {
                                                while ($regcats = mysql_fetch_array($regresults)) {
                                                    echo "<span class='reportdisp'>" . $regcats['funccode'] . "</span>";
                                                }
                                            }
                                            ?>
                                        </p></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><p>
                                            <?php
                                            $findpay = "SELECT * FROM $tablePaymentSponsor WHERE vid='" . $goodrecords[$i]['vid'] . "' ORDER BY id asc";
                            ...
                            <?php for ($i = 0; $i < $cancelledrecordsnum; $i++) { ?>
                                <tr>
                                    <td bgcolor="#CEAFAA"><p><strong>Invoice #: <?php echo $cancelledrecords[$i]['vid']; ?></strong></p></td>
                                    ...
                                    <td bgcolor="#CEAFAA"><p><a href="showInvoice.php?vid=<?php echo $cancelledrecords[$i]['vid']; ?>" target="_blank">View Invoice</a></p></td>
                                </tr>
                                <tr>
                                    <td nowrap><p>Registration Summary:</p></td>
                                    <td colspan="5"><p>
                                            <?php
                                            $findreg = "SELECT * FROM $tabledetailname WHERE vid='" . $cancelledrecords[$i]['vid'] . "' ORDER BY id asc";
                                            $regresults = mysql_query($findreg) or die(mysql_error());
                                            while ($regcats = mysql_fetch_array($regresults)) {
                                                echo "<span class='reportdisp'>" . $regcats['funccode'] . "</span>";
                                            }
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><p>
                                            <?php
                                            $findpay = "SELECT * FROM $tablePaymentSponsor WHERE vid='" . $cancelledrecords[$i]['vid'] . "' ORDER BY id asc";
                                            $payresults = mysql_query($findpay) or die(mysql_error());
                                            while ($payhist = mysql_fetch_array($payresults)) {
                                                echo "<span class='reportdisp'> " . $payhist['date_paid'] . ", " . $payhist['pay_amount'] . ", " . $payhist['transaction_type'] . " </span>";
                                            }
                            ...
                            <?php for ($i = 0; $i < $badrecordsnum; $i++) { ?>
                                <tr>
                                    <td bgcolor="#CCCCCC"><p><strong>Invoice #: <?php echo $badrecords[$i]['vid']; ?></strong></p></td>
                                    ...
                                    <td bgcolor="#CCCCCC"><p><a href="showInvoice.php?vid=<?php echo $badrecords[$i]['vid']; ?>" target="_blank">View Invoice</a></p></td>
                                </tr>
                                <tr>
                                    <td nowrap><p>Registration Summary:</p></td>
                                    <td colspan="5"><p>
                                            <?php
                                            $findreg = "SELECT * FROM $tabledetailname WHERE vid='" . $badrecords[$i]['vid'] . "' ORDER BY id asc";
                                            $regresults = mysql_query($findreg) or die(mysql_error());
                                            while ($regcats = mysql_fetch_array($regresults)) {
                                                echo "<span class='reportdisp'>" . $regcats['funccode'] . "</span>";
                                            }
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><p>
                                            <?php
                                            $findpay = "SELECT * FROM $tablePaymentSponsor WHERE vid='" . $badrecords[$i]['vid'] . "' ORDER BY id asc";
                                            $payresults = mysql_query($findpay) or die(mysql_error());
                                            while ($payhist = mysql_fetch_array($payresults)) {
                                                echo "<span class='reportdisp'> " . $payhist['date_paid'] . ", " . $payhist['pay_amount'] . ", " . $payhist['transaction_type'] . " </span>";
                                            }
