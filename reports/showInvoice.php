...
//////////// process a payment ///////////////////////
                    ...
                    if (isset($_POST['processing'])) {
                        ...
                        $payselect = "SELECT * from $tablePaymentSponsor where sid = '$vid'";
                        ...
                        $updatestmt = "UPDATE $tablesponsor SET invoicedate = '$invoicedate', totalpaid = '$newtotalpaid', totaldue = '$newtotaldue', paytype = '$payment_invoice', miraresponse = '$response', miraamt = '$payment_total', datepaid = '$today' " . $cancellation . " WHERE '$vid' = sid ";
...
//		$newtotalcharged = sprintf("%01.2f",$newtotalcharged);
                            ...
                            $selectDetails = "select * from $tabledetailname where sid = '$vid'";
...
// }
                    ...
                    if (isset($_POST['print'])) {
                        ...
                        $selectStmt = "SELECT * FROM $tablesponsor where '$vid' = sid ";
                        ...
                        // promo code
                        if (!isset($promoCode)) {
                            $promo = "select promoCode from $tablepromo where invoice='$vid'";
...
//echo "<h1>totalcharged: $totalcharged / totalpaid: $totalpaid / funccost: $funccost</h1>";
                            ...
                            if ($n != 1) {
                                ...
                                if (!$penable) { // not enabled
                                    ...
                                    $vupdate = "update $tablesponsor set totalcharged='$totalcharged', totaldue='$totaldue', datepaid='$today', paytype='PROMO' where sid='$vid'";
                        ...
                        <form method='post' action='' name='invoice' ENCTYPE='multipart/form-data' >
                            ...
                            <p><a href="reg_history.php?vid=<?php echo $vid; ?>" onClick="CentreWindow(this.href, 'RegHist', 950, 600);
                                  ...
                                  $invoice_info = str_replace("{sid}", $vid, $invoice_info);
...
////////////////////////////////////////////////////////////////////////////////////
//////////////////////// grab payment history //////////////////////////////////////		
                                  $paymenthist = "select * from $tablePaymentSponsor where sid='$vid' order by id asc";
