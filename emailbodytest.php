...
$funccode = mysql_result($finduser, 0, "funcccode");
...
if ($funccode == "FULL") {
    ...
    $invoice_details .= "<tr><td width=\"100\" class=\"dottheline\">&nbsp;</td><td colspan=\"2\" class=\"dottheline\"><p>General Workshop Discussion and Wrap-Up</p></td>  <td align='right' class=\"dottheline\"><p>--</p></td></tr>";
...
<img src="' . $webURL . '/images/email_top_banner.jpg" alt="Banff/2013 Pipeline Workshop Header">
</td></tr><tr><td width="100" align="left" valign="top"><img src="' . $webURL . '/images/email_side_banner.jpg" alt="Banff/2013 Pipeline Workshop Header"></td><td>&nbsp;&nbsp;&nbsp;</td><td>
...
if (isset($promoItem) && $promoItem) {
    $html_CCfooter = '<h2>Please print out this invoice and bring it to the Banff/2013 Pipeline Workshop pre-registration desk to eliminate any delays.</h2>';
} else {
    $html_CCfooter = '<h2>Please print out this invoice along with the email Credit Card Confirmation from the payment gateway and
					  bring both to the Banff/2013 Pipeline Workshop pre-registration desk to eliminate any delays.</h2>';
}


$html_closingfooter = "<div id=\"conditions\">
				...
				</div><hr><p><em><strong>Your pre-registered workshop package can be picked up at the registration desk at the Banff/2013 Pipeline Workshop</strong></em></p>
		<p>&nbsp;</p></td></tr></table>";

$registrant_message = '';

$billing_message = '
<h2>You have been listed as the Banff/2013 Pipeline Workshop Sponsor Registration billing contact for ' . $strName . '</h2><p>Please keep this email as a confirmation of payment.</p><p>&nbsp;</p>';
...
if ($payOpt == "CC") {
    $mail = new mime_mail();
    $mail->from = "Banff/2013 Pipeline Workshop Sponsor Registration <mail@idassociates.ab.ca>";
    $mail->headers = "Errors-To: mail@idassociates.ab.ca";
    $mail->to = $email;
    //$mail->to = "heidi@idassociates.ab.ca";
    $mail->subject = "Banff/2013 Pipeline Workshop Invoice";
...
if ($totaldue < 0) {
    ...
    //$mail->to = "heidi@idassociates.ab.ca";
    $mail->subject = "REFUND NOTICE!! Banff/2013 Pipeline Workshop REFUND needed for " . $fname . " " . $lname;
